...
public class ReservationModel implements TableModel {
	...
	public void insertRow(String reservationId, int cruiseNo, java.sql.Date dateOfReservesation, java.sql.Date l)
			throws SQLException {

		try {
			this.reservationRowSet.moveToInsertRow();
			this.reservationRowSet.updateString("reservationNo", reservationId);
			this.reservationRowSet.updateInt("cruiseNo", cruiseNo);
			this.reservationRowSet.updateDate("dateReservationMade", dateOfReservesation);
